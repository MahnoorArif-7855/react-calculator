...
handleSideFunctions = value => {
    ...
    if(this.state.sideOperators === "sin("){
        ...
        let result= this.state.deg ?
         Math.asin((i*Math.PI)/180) : Math.asin(i);
        this.calculate(result);
        this.setState({
            displayInput: newInput
        });
            ...
            let result= this.state.deg ?
             Math.cos((x*Math.PI)/180) : Math.cos(x);
            this.calculate(result);
            this.setState({
                displayInput: newInput
            });
                ...
                let result= this.state.deg ?
                 Math.acos((i*Math.PI)/180) : Math.acos(i);
                this.calculate(result);
                this.setState({
                    displayInput: newInput
                });
            ...
            let result= this.state.deg ?
          Math.tan((x*Math.PI)/180) : Math.tan(x);
          this.calculate(result);
            this.setState({
        displayInput: newInput
    });
        ...
        let result= this.state.deg ?
        Math.atan((i*Math.PI)/180) : Math.atan(i);
       this.calculate(result);
       this.setState({
           displayInput: newInput
    });
    ...
    //     let exponent =newInput.slice(newInput.indexOf("^") + 1);
    //     let display = newInput + value;
    //     let result = `result.pow( ${base}, ${exponent} )`;
    //     this.calculate(result);
    //     this.setState({
    //     displayInput: display
    //         });
